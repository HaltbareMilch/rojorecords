...
export const Home = () => {
  {/*Checkt ob das Mobile Menü active ist oder nicht.*/}
  ...
  return (
    <>
      ...
      <TrackSection isMusicOpen={isMusicOpen} toggleMusic={toggleMusic} {...test}/>
      <Footer />
      <MusikSection isMusicOpen={isMusicOpen} toggleMusic={toggleMusic}/>
    </>
  )
}
